...
GameManager.prototype.move = function (direction) {
  ...
  function nextValue(a, b) {
    ...
    // Länsisuomalainen -> Satakuntalainen + Turkulainen
    // Turkulainen -> VSO + ÅN
    if (a == "VSO" && b == "ÅN") return "Turku";
    ...
    traversals.y.forEach(function (y) {
      ...
      if (tile) {
        ...
        if (next && mergeable(next.value, tile.value) && !next.mergedFrom) {
          var merged = new Tile(positions.next, nextValue(next.value, tile.value));
          ...
          // Update the score
          self.score += valueToScore(merged.value);

          // The mighty 2048 tile
          if (merged.value === "Länsi") self.won = true;
        } else {
